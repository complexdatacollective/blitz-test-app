...
import logo from "public/assets/images/studio-dark.svg"
import { CgBell, CgClose, CgMenu, CgSpinner } from "react-icons/cg"
...
const UserInfo = () => {
  ...
  // If we are not logged in, return the login/signup buttons
  if (!currentUser) {
    return (
      <>
...
const navigation = [
  ...
  { name: "Projects", href: Routes.ProjectsPage() },
]
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center justify-start">
                  <div className="block lg:hidden h-8 w-auto">
                    <Image src={logo} alt="Network Canvas Studio" height="32px" width="100px" />
                  </div>
